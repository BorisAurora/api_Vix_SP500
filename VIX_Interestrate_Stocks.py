...
st.write("According to the Consumer Price Index the price of consumer goods has increased:",cpi_delta,"% the last two years")
 
st.write( "The plot beneath shows the correlation between the VIX and S&P500 for the last two years")
st.pyplot(fig_)

st.write( "The plot beneath shows the correlation between inflation, yields and tech-stocks for the last two years")
st.pyplot(fig)
